...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "analyzed_url_results" ADD CONSTRAINT "analyzed_url_results_analyzed_url_revision_id_analyzed_url_revisions_id_fk" FOREIGN KEY ("analyzed_url_revision_id") REFERENCES "public"."analyzed_url_revisions"("id") ON DELETE cascade ON UPDATE restrict;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "analyzed_url_results" ADD CONSTRAINT "analyzed_url_results_redirect_analyzed_url_id_analyzed_urls_id_fk" FOREIGN KEY ("redirect_analyzed_url_id") REFERENCES "public"."analyzed_urls"("id") ON DELETE cascade ON UPDATE restrict;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "analyzed_url_revisions" ADD CONSTRAINT "analyzed_url_revisions_analyzed_url_id_analyzed_urls_id_fk" FOREIGN KEY ("analyzed_url_id") REFERENCES "public"."analyzed_urls"("id") ON DELETE cascade ON UPDATE restrict;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "analyzed_url_revisions" ADD CONSTRAINT "analyzed_url_revisions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE restrict;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "analyzed_url_revisions" ADD CONSTRAINT "analyzed_url_revisions_guild_id_guilds_id_fk" FOREIGN KEY ("guild_id") REFERENCES "public"."guilds"("id") ON DELETE cascade ON UPDATE restrict;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "users_discord_id_index" ON "users" ("discord_id");